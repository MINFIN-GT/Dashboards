...
import dao.varios.CPrestamoDAO2;
import pojo.varios.CPrestamo2;

/**
 * Servlet implementation class SPrestamo
 */
@WebServlet("/SPrestamos2")
public class SPrestamos2 extends HttpServlet {
	...
	private String getAllPrestamos(Map<String, String> map) {
		...
		List<CPrestamo2> cPrestamos = CPrestamoDAO2.getPrestamos();
		List<Prestamo> prestamos = new ArrayList<Prestamo>();

		for (CPrestamo2 cPrestamo : cPrestamos) {
	...
	private String getPrestamosByEntidad(Map<String, String> map) {
		...
		List<CPrestamo2> cPrestamos = CPrestamoDAO2.getPrestamosByEntidad();
		List<Prestamo> prestamos = new ArrayList<Prestamo>();
	...
	private String getPrestamosByOrganismo(Map<String, String> map) {
		...
		List<CPrestamo2> cPrestamos = CPrestamoDAO2.getPrestamosByOrganismo();
		List<Prestamo> prestamos = new ArrayList<Prestamo>();
