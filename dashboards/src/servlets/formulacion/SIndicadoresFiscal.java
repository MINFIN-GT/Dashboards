...
import dao.formulacion.CIndicadoresFiscal;
 ...
 */
@WebServlet("/SIndicadoresFiscal")
public class SIndicadoresFiscal extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SIndicadoresFiscal() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("getReporte")) {
			if(ejercicio>0) {
				ArrayList<CIndicadorFiscal> lineas = CIndicadoresFiscal.getReporte(ejercicio);
