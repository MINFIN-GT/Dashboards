...
public class SDeuda extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("getEjecucionTotal")) {
			ArrayList<CDeudaMensualizada> resultados = CDeudaDAO.getEjecucionTotalPorMes(ejercicio);
			
			response_text=new GsonBuilder().serializeNulls().create().toJson(resultados);
