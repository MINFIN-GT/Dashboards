...
public class CInstitucionalTipoGastoDetalle {
	int ejercicio;
	int codigo;
	String nombre;
	Double recomendado;
	...
	public CInstitucionalTipoGastoDetalle(int ejercicio, int codigo, String nombre, Double recomendado,
			Double tp11_monto, Double tp12_monto, Double tp13_monto, Double tp21_monto, Double tp22_monto,
			Double tp23_monto, Double tp31_monto, int nivel) {
		super();
