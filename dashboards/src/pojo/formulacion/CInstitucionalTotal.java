...
public class CInstitucionalTotal {
	...
	Double recomendado;
	ArrayList<CInstitucionalTotal> children;
	Integer nivel;
	
	public CInstitucionalTotal(int ejercicio, int entidad, String entidad_nombre, Integer unidad_ejecutora, String unidad_ejecutora_nombre,
	...
	public ArrayList<CInstitucionalTotal> getChildren() {
		return children;
	}
	
	public void setChildren(ArrayList<CInstitucionalTotal> children) {
		this.children = children;
	}
