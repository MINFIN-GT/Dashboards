	...
	public static List<CPrestamo2> getPrestamos() {
		...
		try{
			if(conn!=null && !conn.isClosed()){
				...
				while (rs.next()) {
					CPrestamo2 prestamo = new CPrestamo2(null, null, null, null, null, rs.getInt("correlativo"),
	...
	public static List<CPrestamo2> getPrestamosByEntidad() {
		...
		try{
			if(conn!=null && !conn.isClosed()){
				...
				while (rs.next()) {
					CPrestamo2 prestamo = new CPrestamo2(null, null, null, null, null, null, null, null,
	...
	public static List<CPrestamo2> getPrestamosByOrganismo() {
		...
		try{
			if(conn!=null && !conn.isClosed()){
				...
				while (rs.next()) {
					CPrestamo2 prestamo = new CPrestamo2(null, null, null, rs.getInt("organismo"),
