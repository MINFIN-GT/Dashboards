<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div ng-controller="copeprenglonController as ejecucion" class="maincontainer" id="title" class="all_page">
<h4>Cuotas COPEP por Renglón</h4>
<div class="row">
	<div class="col-sm-12">
		...
		<div style="height: 35px;">
			...
			<div style="text-align: right;">
				<div class="btn-group" role="group" aria-label="">
					<a class="btn btn-default" href="#!/dashboards/copeprenglon/gt1" role="button" uib-tooltip="Reiniciar la vista de la tabla" tooltip-placement="left"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span></a>
