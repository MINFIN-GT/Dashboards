...
<div ng-controller="pepm_Controller as ctrlPEPM" class="maincontainer" id="title" class="all_page">
	<h3>Prestamos para Ejecución Presupuestaria</h3>
	<br/>
	...
	<div class="row">
		<div class="col-sm-12 col-centered">
			<h5 class="text-center">Ejecución de prestamos según entidad y unidad ejecutora</h5>
			<br/>
			<table class="table table-hover" style="width: 90%; margin: 0 auto;">
				...
				<tbody data-ng-repeat="prestamos in ctrlPEPM.prestamos track by $index">
					<tr>
						<td class="text-nowrap" ng-if="prestamos.nivel === 0" style="padding-left: 0px; font-weight: bold;">{{ prestamos.nombre }}</td>
						...
						<td class="text-right">{{ prestamos.asignado | currency:"Q&nbsp;":2 }}</td>
						<td class="text-right">{{ prestamos.modificaciones | currency:"Q&nbsp;":2  }}</td>
						<td class="text-right">{{ prestamos.vigente | currency:"Q&nbsp;":2  }}</td>
						<td class="text-right">{{ prestamos.ejecutado | currency:"Q&nbsp;":2  }}</td>
						<td class="text-center">{{ prestamos.porcentaje | number:2}}&nbsp;%</td>
					</tr>
				</tbody>
				<tfoot>
					<tr style="font-weight: bold;">
						<td class="text-right"><strong>Totales</strong></td>
						<td class="text-right"><strong>{{ ctrlPEPM.prestamos_totales[0] | currency:"Q&nbsp;":2  }}</strong></td>
						<td class="text-right"><strong>{{ ctrlPEPM.prestamos_totales[1] | currency:"Q&nbsp;":2 }}</strong></td>
						<td class="text-center"><strong>{{ ctrlPEPM.prestamos_totales[2] | currency:"Q&nbsp;":2 }}</strong></td>
						<td class="text-right"><strong>{{ ctrlPEPM.prestamos_totales[3] | currency:"Q&nbsp;":2 }}</strong></td>
						<td class="text-center"><strong>{{ ctrlPEPM.prestamos_totales[4]  | number:2}}&nbsp;%</strong></td>
					</tr>				</tfoot>
			</table>
		</div>
	</div>
			...
			<table class="table table-hover" style="width: 90%; margin: 0 auto;">
				...
				<tbody>
					<tr ng-repeat="entidad in ctrlPEPM.tabla_entidades track by $index">
						...
						<td class="text-right">{{ ctrlPEPM.tabla_entidades[$index].asignado | currency:"Q&nbsp;":2 }}</td>
						<td class="text-right">{{ ctrlPEPM.tabla_entidades[$index].modificaciones | currency:"Q&nbsp;":2 }}</td>
						<td class="text-right">{{ ctrlPEPM.tabla_entidades[$index].vigente | currency:"Q&nbsp;":2 }}</td>
						<td class="text-right">{{ ctrlPEPM.tabla_entidades[$index].ejecutado | currency:"Q&nbsp;":2  }}</td>
						<td class="text-center">{{ ctrlPEPM.tabla_entidades[$index].porcentaje | number:2}}&nbsp;%</td>
					</tr>
					<tr>
						<td class="text-right"><strong>Totales</strong></td>
						<td class="text-right"><strong>{{ ctrlPEPM.tabla_entidades_totales[0] | currency:"Q&nbsp;":2  }}</strong></td>
						<td class="text-right"><strong>{{ ctrlPEPM.tabla_entidades_totales[1] | currency:"Q&nbsp;":2 }}</strong></td>
						<td class="text-right"><strong>{{ ctrlPEPM.tabla_entidades_totales[2] | currency:"Q&nbsp;":2  }}</strong></td>
						<td class="text-right"><strong>{{ ctrlPEPM.tabla_entidades_totales[3] | currency:"Q&nbsp;":2  }}</strong></td>
						<td class="text-center"><strong>{{ ctrlPEPM.tabla_entidades_totales[4] | number:2 }}&nbsp;%</strong></td>
					</tr>
				</tbody>
			</table>
