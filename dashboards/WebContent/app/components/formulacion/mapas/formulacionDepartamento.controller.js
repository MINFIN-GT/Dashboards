var modGastoGeneral = angular.module('maparecomendadoDepartamentoController', [ 'dashboards',
		'ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ngMap']);

// Control principal
modGastoGeneral.controller('maparecomendadoDepartamentoController',
...
function maparecomendadoController($uibModal, $http,NgMap) {
	...
	function obtenerCodigo(codigo){
		for(var i=0; i<me.departamentos.length;i++){
			if(me.departamentos[i].codigo==codigo)
				return me.departamentos[i];
		}
	}
