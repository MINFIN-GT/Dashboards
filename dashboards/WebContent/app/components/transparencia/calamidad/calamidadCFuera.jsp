<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div ng-controller="CFueraCtrl as control" class="maincontainer" id="title">
	<h3>Tablero de Seguimiento a Estados de {{ control.tipo }} - {{ control.titulo }}</h3>
	<br/>
	<div class="row">
		<div class="col-sm-12">
			<h4>Compras realizadas posteriormente al estado de {{ control.tipo }}, en el programa 94 y subprograma {{ control.subprograma }}</h4>
		</div>
	</div>
